...
@foreach ($chirps as $ch)
  <div class="max-w-2xl mx-auto mt-16">
    <div class="flex items-start gap-2.5">
      <img class="w-8 h-8 rounded-full" src="{{ asset('uploads/avatar.avif') }}" alt="Jese image">
...
@if(session('success'))
    <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
        ...
        <button class="absolute top-0 bottom-0 right-0 px-4 py-3" onclick="this.parentElement.style.display='none';" aria-label="Close">
            &times;
        </button>
    </div>
@endif
